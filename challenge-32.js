...
Ele irá ser executado na porta 3001, que pode ser acessada via browser no endereço: 
`http://localhost:3001`
...
- Para cadastrar um novo carro, faça um POST no endereço `http://localhost:3001/car`, enviando
os seguintes campos:
